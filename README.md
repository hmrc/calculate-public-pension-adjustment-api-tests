...
# calculate-public-pension-adjustment-api-tests
...
Run the following commands to start services locally:
    ...
    sm2 --start CALCULATE_PUBLIC_PENSION_ADJUSTMENT -r --wait 100
    sm2 --start PENSION_ANNUAL_ALLOWANCE_CALCULATOR -r --wait 100
